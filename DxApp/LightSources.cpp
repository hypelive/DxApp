...
void LightSources::AddSpot(SpotLightSource lightSource)
{
	assert(m_spotLightSourcesCount < kMaxSpotLightSourcesCount);
	m_spotLightSources[m_spotLightSourcesCount++] = lightSource;
}
